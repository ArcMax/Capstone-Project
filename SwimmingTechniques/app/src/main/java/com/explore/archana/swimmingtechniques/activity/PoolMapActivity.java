...
import com.explore.archana.swimmingtechniques.application.AppController;
 ...
 */
public class PoolMapActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener {

    private static final String TAG = "PoolMapActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.pool);
        ...
        try {
            ...
            if (result.getString(AppConfig.STATUS).equalsIgnoreCase(AppConfig.OK)) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    id = place.getString(AppConfig.POOL_ID);
                ...
                Toast.makeText(getBaseContext(), jsonArray.length() + " Pools found!",
                        Toast.LENGTH_LONG).show();
            } else if (result.getString(AppConfig.STATUS).equalsIgnoreCase(AppConfig.ZERO_RESULTS)) {
                Toast.makeText(getBaseContext(), "No Pools found in 5KM radius!!!",
                        Toast.LENGTH_LONG).show();
            }
